...
static void InitDefaultsscc_info_TestMessage_test_2eproto() {
  ...
  {
    void* ptr = &::test::_TestMessage_default_instance_;
    new (ptr) ::test::TestMessage();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::test::TestMessage::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::test::TestMessage, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::test::TestMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::test::TestMessage, testenum_),
  PROTOBUF_FIELD_OFFSET(::test::TestMessage, testint_),
  0,
  1,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::test::TestMessage)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::test::_TestMessage_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  &descriptor_table_test_2eproto_initialized, descriptor_table_protodef_test_2eproto, "test.proto", 130,
...
class TestMessage::_Internal {
 public:
  ...
  static void set_has_testenum(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
...
TestMessage::TestMessage(const TestMessage& from)
  ...
  ::memcpy(&testenum_, &from.testenum_,
    static_cast<size_t>(reinterpret_cast<char*>(&testint_) -
    reinterpret_cast<char*>(&testenum_)) + sizeof(testint_));
  // @@protoc_insertion_point(copy_constructor:test.TestMessage)
}

void TestMessage::SharedCtor() {
  ::memset(&testenum_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::test::TestEnum_IsValid(val))) {
            _internal_set_testenum(static_cast<::test::TestEnum>(val));
          } else {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          testint_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* TestMessage::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      1, this->_internal_testenum(), target);
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:test.TestMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const TestMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TestMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:test.TestMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:test.TestMessage)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:test.TestMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void TestMessage::InternalSwap(TestMessage* other) {
  ...
  swap(testenum_, other->testenum_);
...
template<> PROTOBUF_NOINLINE ::test::TestMessage* Arena::CreateMaybeMessage< ::test::TestMessage >(Arena* arena) {
  return Arena::CreateInternal< ::test::TestMessage >(arena);
}
