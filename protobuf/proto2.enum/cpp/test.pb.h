...
constexpr TestEnum TestEnum_MIN = UNKOWN;
constexpr TestEnum TestEnum_MAX = ENUM2;
...
class TestMessage :
 ...
 public:
  ...
  public:
  void clear_testenum();
  ::test::TestEnum testenum() const;
  void set_testenum(::test::TestEnum value);
  private:
  ::test::TestEnum _internal_testenum() const;
  void _internal_set_testenum(::test::TestEnum value);
  public:

  // required int32 testInt = 2;
  bool has_testint() const;
  private:
  bool _internal_has_testint() const;
  public:
  void clear_testint();
...
inline bool TestMessage::has_testenum() const {
  return _internal_has_testenum();
}
inline void TestMessage::clear_testenum() {
  testenum_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::test::TestEnum TestMessage::_internal_testenum() const {
  return static_cast< ::test::TestEnum >(testenum_);
}
inline ::test::TestEnum TestMessage::testenum() const {
  // @@protoc_insertion_point(field_get:test.TestMessage.testEnum)
  return _internal_testenum();
}
inline void TestMessage::_internal_set_testenum(::test::TestEnum value) {
  assert(::test::TestEnum_IsValid(value));
  _has_bits_[0] |= 0x00000001u;
  testenum_ = value;
}
inline void TestMessage::set_testenum(::test::TestEnum value) {
  _internal_set_testenum(value);
  // @@protoc_insertion_point(field_set:test.TestMessage.testEnum)
}

// required int32 testInt = 2;
inline bool TestMessage::_internal_has_testint() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool TestMessage::has_testint() const {
  return _internal_has_testint();
}
inline void TestMessage::clear_testint() {
  testint_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TestMessage::_internal_testint() const {
  return testint_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TestMessage::testint() const {
  // @@protoc_insertion_point(field_get:test.TestMessage.testInt)
  return _internal_testint();
}
inline void TestMessage::_internal_set_testint(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  testint_ = value;
}
inline void TestMessage::set_testint(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_testint(value);
  // @@protoc_insertion_point(field_set:test.TestMessage.testInt)
}
